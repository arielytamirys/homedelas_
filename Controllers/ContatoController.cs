...
namespace Homedelas.Models.Controllers
{
    public class ContatoController : Controller
    {
        ...
        public ContatoController(InicialContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id_Contato,Email,WhatsApp")] Contato contato)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id_Contato,Email,WhatsApp")] Contato contato)
        {
